...
const WORLD_HALF = 5; // world coords span [-5,5]
...
export default function GreensCanvas({
  ...
  // Pull theme colors from CSS variables (re-read on any repaint tick is cheap enough)
  useEffect(() => {
  ...
  function drawBoundary(ctx: CanvasRenderingContext2D, polygon: Point[]) {
    ...
    // resize handle at rightmost point
  ...
  // --- Pointer interaction: drag to move, drag handle to resize ---
