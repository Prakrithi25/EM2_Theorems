          ...
          >
            ...
            <div className="flex items-center justify-between border-b pb-4" style={{ borderColor: 'var(--line)' }}>
              <div>
                ...
                <p className="text-xs mt-0.5" style={{ color: 'var(--ink-soft)' }}>
                  Reporting from: <strong className="text-teal-400">{siteName}</strong>
                </p>
              </div>
              <button
            ...
            {status === 'success' ? (
              <div className="py-8 text-center space-y-3">
                <div className="w-12 h-12 rounded-full bg-teal-500/20 text-teal-400 flex items-center justify-center text-2xl mx-auto border border-teal-500/30">
                  ✓
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl p-3.5 text-xs font-medium border outline-none focus:border-teal-500 transition-colors resize-none"
                    style={{
                      backgroundColor: 'var(--panel-2)',
                      borderColor: 'var(--line)',
                      color: 'var(--ink)',
                  ...
                  <div className="flex flex-wrap gap-2.5 items-center">
                    ...
                    {images.length < 4 && (
                      <button
                        ...
                        className="w-16 h-16 rounded-lg border border-dashed flex flex-col items-center justify-center gap-1 transition-colors hover:border-teal-400 cursor-pointer text-xs"
                ...
                <div className="flex items-center justify-end gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="px-5 py-2 rounded-xl text-xs font-bold bg-teal-500 text-gray-950 hover:bg-teal-400 transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {status === 'submitting' ? (
                      <>
